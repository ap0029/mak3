...
a.$root.find(a.options.iosBtnPath).on("click",function(){jQuery(this).next(a.options.panelPath).toggleClass("jplist-ios-show")})},e=function(c,e){var b={observer:null,
...
b.history=new jQuery.fn.jplist.History(b.$root,b.options,b.observer);b.panel=new jQuery.fn.jplist.PanelController(e,b.options,b.history,b.observer);b.storage=new jQuery.fn.jplist.Storage(b.options.storage,b.options.storageName,b.options.cookiesExpiration);b.itemControls=new jQuery.fn.jplist.ItemControlCollection(b.options,b.observer,b.history,b.$root);b.controller=new jQuery.fn.jplist.DOMController(b.$root,b.options,b.observer,b.panel.paths);a(b);b.options.deepLinking?
